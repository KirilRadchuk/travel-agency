...
import z from "zod"
import { BaseRegisterSchema, getRegisterSchema } from "@/lib/validators"
import { zodResolver } from "@hookform/resolvers/zod";

type FormFields = z.infer<typeof BaseRegisterSchema>;
...
export function RegisterForm({
    ...
    const registerSchema = getRegisterSchema(authT);
                        ...
                        <FieldGroup>
                            ...
                            <Field>
                                ...
                                <FieldDescription className="text-center">
                                    {t("not-account")} <Link href="/login">{t("sign-up")}</Link>
                                </FieldDescription>
                            </Field>
